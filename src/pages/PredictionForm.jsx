...
export default function PredictionForm() {
  ...
  if (locationTables.length > 0) allButtons.push({ numericId: parseInt((locationTables[0]?.id || 'T14').replace('T', ''), 10), key: 'locations', stageType: 'qualifiers', description: 'מיקומים בתום שלב הבתים', sectionKey: 'locations' });
