...
export default function LeaderboardNew() {
  ...
  const loadParticipantDetails = async (participantName) => {
    ...
    try {
      ...
      const locationTableDescriptions = {};
      allQuestions.forEach(q => {
        if (LOCATION_TABLE_IDS.includes(q.table_id) && !locationTableDescriptions[q.table_id]) {
          locationTableDescriptions[q.table_id] = q.table_description || q.table_id;
        }
      });
